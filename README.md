## 关于Qmik [下载压缩](http://g.tbcdn.cn/tmmob/qmik/1.3.61/Qmik.js)
...
## API简介:
        ...
        now([date]) :   当前时间
        delay(fun, time [arg1, arg2, arg3,...]) (https://github.com/leochen36/qmik/wiki/$.delay)  延迟执行,类似setTimeout,返回一个对象,对象有个 stop方法,用于停止执行,...表示要传输的参数,如:$.delay(function(a1,a2){},1000,1,2);//1 对应 a1,2对应 a2
        // 
        /**
         * fun:执行的方法
         * cycleTime:执行的周期时间
